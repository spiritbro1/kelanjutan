...
export const parseProductData = (data: Buffer,productKey:any): ProductData => {
  // pyth magic number
  const magic = data.readUInt32LE(0)
  // program version
  const version = data.readUInt32LE(4)
  ...
  const base58=priceAccountKey.toBase58()
  ...
  return { magic, version, type, size, priceAccountKey, product,base58,productKey,publisher:{}}
}
